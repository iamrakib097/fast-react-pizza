...
const Button = ({ children, disabled, to, type }) => {
  ...
  const style = {
    ...
    secondary: `text-sm inline-block rounded-full
       md:px-6 md:py-4 px-3.5 py-2.5  border-2 
       border-stone-300  font-semibold uppercase 
       tracking-wide text-stone-400 transition-colors 
       duration-300 hover:bg-stone-300 focus:bg-stone-300 
       focus:outline-none focus:ring focus:ring-stone-200 
       focus:ring-offset-2 hover:text-stone-800 focus:text-stone-800
